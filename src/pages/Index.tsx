...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'dark' : ''}`}>
            ...
            <div className="relative">
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/10 to-orange-500/10 p-8 backdrop-blur-xl border border-primary/20 shadow-2xl">
                <picture>
                  ...
                  <img 
                    src="/uploads/791503c7-e420-4b36-9ea3-b1c64a828745.jpg" 
      ...
      {/* About, Services, Contact, Footer Sections remain unchanged — continue here... */}
      ...
      <section id="gallery" className="py-16 px-4 bg-muted/30">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              "/uploads/791503c7-e420-4b36-9ea3-b1c64a828745.png",
              "/uploads/5901ee9c-4e85-4e85-9c26-27d7182b80ae.png",
              "/uploads/2a1e7bcb-cda7-4744-a7d2-8f0462655e55.png",
              "/uploads/1434fe8d-9879-4d13-82c9-1e30fa6efb82.png",
              "/uploads/85afbe75-4b79-4b50-a8fa-84a0913dea9c.png",
              "/uploads/f94383a7-49ae-4c49-9a01-9af8371d0589.png",
              "/uploads/4ec8d538-80c7-4d13-ae10-e3228fb22b09.png",
              "/uploads/2eb02de7-d37e-4fd4-a032-c404e42931f8.png"
            ].map((src, index) => {
